...
class Mlp(nn.Module):
    ...
    def forward(self, x):
        ...
        x = x.reshape(B, H, W, C).reshape(B, nH, self.window_size, nW, self.window_size, C).\
        ...
        x = x.reshape(B, nH, nW, self.window_size, self.window_size, C).permute(0, 1, 3, 2, 4, 5).contiguous()
